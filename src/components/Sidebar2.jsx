  ...
  return (
    <div className={`sidebar second-option text-white ${isOpen ? 'open' : 'collapsed'}`}>
      ...
      <ul className="list-unstyled mt-4 sorath-header-li">
        <li className={`btn-style2 px-3 ${location.pathname === '/table1' ? 'active' : ''}`}>
          <Link
          ...
          >
            ...
            <span className="menu-text ms-3">Table 1</span>
          </Link>
        </li>
        <li className={`btn-style2 px-3 ${location.pathname === '/table2' ? 'active2' : ''}`}>
          <Link
            className="text-decoration-none d-flex align-items-center"
            to="/table2"
            data-bs-toggle="tooltip"
        ...
        <li className={`btn-style2 px-3 ${location.pathname === '/table3' ? 'active' : ''}`}>
          <Link
            className="text-decoration-none d-flex align-items-center"
            to="/table3"
            data-bs-toggle="tooltip"
